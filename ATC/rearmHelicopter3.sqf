...
if ((_veh distance pad3) < 5) then 
	{
		{_x setObjectTexture [0,"#(rgb,8,8,3)color(0,1,0,1)"];} foreach pad_spheres3;
		sleep 0.2;
		{_x setObjectTexture [0,"#(rgb,8,8,3)color(0,0,1,1)"];} foreach pad_spheres3;
		sleep 0.2;
		{_x setObjectTexture [0,"#(rgb,8,8,3)color(0,1,0,1)"];} foreach pad_spheres3;
		sleep 0.2;
		{_x setObjectTexture [0,"#(rgb,8,8,3)color(1,1,0,1)"];} foreach pad_spheres3;
		sleep 1;
		{_x setObjectTexture [0,"#(rgb,8,8,3)color(1,0,0,1)"];} foreach pad_spheres3;			
